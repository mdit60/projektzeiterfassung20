...
**Status:** Session 32 abgeschlossen: Laufzeit im Fortschritt-Header, Drucken/PDF-Export, ZA-Deckblatt 3-Zeilen-Struktur, Kontrast-Verbesserungen ProjektFortschrittPanel.
...
| PortalNav.tsx | 7.4.4-4 | Portal-Navigation kontextsensitiv + Kundenfirmen immer sichtbar auf Unterseiten |
...
| BerichtePage.tsx | 7.4.6-3 | Berichte & Controlling + Accordion + Zeiterfassungs-Status unter Matrix |
| ProjektFortschrittPanel.tsx | 7.4.5-11 | Zielerreichungs-Prognose (Projektions-Linien, GF-Regel, Foerder-Konsequenzen) |
...
**#0 - NWM-Prognose im ProjektFortschrittPanel (Session 32)**

ZIM_NETZWERK-Projekte haben mehrere Netzwerkjahre mit gestuften Foerderquoten
(z.B. Jahr 1=70%, Jahr 2=50%). Das Panel zeigt aktuell einen linearen Verlauf.
- Soll-Berechnung aus v7_nwm_ap_planung statt v7_work_package_assignments
- Monatsverlauf: Knick an Netzwerkjahr-Grenze (ab August 2026 flacher)
- Foerder-Konsequenzen je Netzwerkjahr separat ausweisen
- Tabellen v7_nwm_foerderzeitraeume + v7_nwm_ap_planung bereits in PROD

**#1 - NWM Jahresabrechnung pruefen**
...
**#2 - WICHTIGSTE PRIO: User-Manuals aktualisieren**
...
- Zielerreichungs-Prognose im ProjektFortschrittPanel (NEU Session 31)
- BerichtePage Accordion + Zeiterfassungs-Status unter Matrix (NEU Session 31)

Diese Manuals sollten komplett neu geschrieben werden, nicht nur
patchmaessig ergaenzt.

**#3 - Berater-Portal User Manual (PDF)**
...
**#7 - Gestaffelte Foerderquoten (foerdersatz_stufen)**

Runtime + UI pruefen. JSONB-Feld besteht seit v7.4.4, Logik noch nicht
vollstaendig durchgeprueft.

**#8 - Multiprojekt-Tool, Forschungszulage-Modul, De-minimis-Datenbank**

Konzepte noch offen.

**#9 - Nice-to-have: Vercel-Setup (§14)**
...
**Session 31 (24. April 2026):**
- ProjektFortschrittPanel v7.4.5-11: Zielerreichungs-Prognose komplett neu
  - Projektions-Linie (orange) + Zieltempo-Linie (gruen) im Monatsverlauf-Diagramm
  - 3-Spalten Prognose-Block: Hochrechnung / Aktuelle Situation + Szenarien / Foerder-Konsequenzen
  - GF-Erkennung via position_title (50%-Regel ZIM), individuelle Obergrenzen je MA
  - Foerder-Konsequenzen: abrufbare Foerdermittel + verschenktes Geld (echte Stundensaetze)
  - Disclaimer: Durchschnittswerte zur Orientierung
- BerichtePage v7.4.6-3: Accordion (nur ein Panel offen), Zeiterfassungs-Status unter Matrix
...
|---------|-------|-------------|
| v4.75 | 25.04.2026 | Session 32: Laufzeit Header Fortschritt, Drucken/PDF, ZA 3-Zeilen, Anthrazit-Kontrast |
| v4.74 | 24.04.2026 | Session 31: ProjektFortschrittPanel v7.4.5-11 (Zielerreichungs-Prognose, 3-Spalten, GF-Regel, Foerder-Konsequenzen). BerichtePage v7.4.6-3 (Accordion, Zeiterfassungs-Status unter Matrix). PortalNav v7.4.4-4 (Kundenfirmen immer sichtbar auf Unterseiten). |
