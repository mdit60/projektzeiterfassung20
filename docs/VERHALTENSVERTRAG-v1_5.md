...
**Version 1.5 - fortgeschrieben in Session 86 (21.09.2026)**
**Datum:** 21. September 2026
**Loest ab:** VERHALTENSVERTRAG-v1_4.md (Session 85, 17.09.2026)
...
> PFLICHTENHEFT-v5_47-AENDERUNGSBLOCK.md. Dieses Dokument ist die kompakte
> Arbeitskopie.
...
| ZA-14 | **Foerderbetrag centgenau, neu in v1.5** | antZuwendung, computeArchivFoerderbetrag (beide Zweige), nwmFoerderbetrag: kaufmaennisch auf 2 Dezimalen ueber round2() aus der Lib. Nicht mehr Math.round() auf ganze Euro |
...
| VN-04 | Schlusszahlung | Zuwendung gesamt - bisher erhaltene Zuwendungen (Summe zahlungseingang_betrag); negativ = Rueckforderung, eigene Warnung |
| VN-05 | Abweichungswarnung mit Toleranz | Warnung, wenn Summe der ZA-Anforderungen vom Anspruch abweicht, erst ueber (Anzahl ZA + 1) x 0,005 EUR (strukturelle Rundung). Schwelle als finanzierung.abweichungRelevant aus der Lib, nicht in der Anzeige nachbauen |
...
- **Zeitraumfilter der ZA:** Eine ZA zaehlt nur, wenn ihr GESAMTER Zeitraum im
  Berichtszeitraum liegt. Wer den Berichtszeitraum enger zieht, verliert ganze ZA
...
| IF-13 | Rundung centgenau (v1.5) | Geldbetraege kaufmaennisch auf 2 Dezimalen ueber round2() aus der VN-Lib. Nie Math.round(x) auf ganze Euro - rundet auch auf und fordert dann mehr als den Foerdersatz an |
