...
Kapazitätsplanung, §3, §8, §10, §11)
**Status:** UMGESETZT und in Produktion (siehe §11 Umsetzungsstand)
**Betrifft:** PZE V7, `TimesheetForm`, Lesepfade des Stundennachweises und (ab V7.9.10)
...
| `berater/multiprojekt/[id]/page.tsx` (FZul-Detail) | **noch nicht angepasst** — liest die zentrale Abwesenheitstabelle nicht (A-067) | — |
...
- **FZul-Detailseite** (`/v7/berater/multiprojekt/[id]`, Jahreskalender und
  BSFZ-Export) liest `v7_employee_absences` nicht; an E-Tagen werden volle
  FZul-Stunden angeboten (A-067).
