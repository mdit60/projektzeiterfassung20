...
**Status:** Session 23: Feiertags-Utility zentralisiert, kommunale Sonderfaelle UI + Logic, FirmendatenCard JSX-Fix
...
**Deploy-Strategie:**
- NUR DEV in dieser Session (Testkunden auf PROD unberuehrt lassen)
- PROD-Merge auf main erst nach GO durch Martin
...
- Gestaffelte Foerderquoten (foerdersatz_stufen): Runtime + UI pruefen
- Stundennachweis Wording projekttyp-spezifisch: "foerderbare Projektarbeiten" vs. "Management-Arbeiten"
- Berater-Portal User Manual (PDF)
- Anleitungen Admin + PL aktualisieren (Notizen-Funktion, Monats-Einschraenkung etc.)
