...
**Status:** Session 41: Cockpit als Berater-Zentrale -- Monatsverlauf, Prognose, Firma-Dropdown, PortalNav, Action-Buttons.
...
- Action-Buttons: Ziel-Navigation verfeinern (aktuell alte Detail-Seiten, spaeter
  direkt im Cockpit integrierte Dialoge)
- ProjektFortschrittPanel refactoren auf projektfortschritt-utils
- "Alle Projekte"-Option im Dropdown (Firmen-Gesamtueberblick)
- Berater-Landing nach Login direkt aufs Cockpit
...
| PortalNav.tsx | **7.4.4-14** | Navigation: Cockpit + Kundenfirmen + Netzwerk + Kapazitaetsplanung |
| ProjectTeamManager.tsx | **7.4.4-17** | Team-Verwaltung, ROLE_OPTIONS auf 3 ZA-Werte reduziert |
| SystemConfigPanel.tsx | **7.4.4-1** | Toggle Anleitungs-Downloads (manuals_enabled) |
...
| ZAPanel.tsx | **7.4.4-40** | Archiv-Tab neu: Zahlungseingang inline, Foerderbetrag live+gespeichert, Einreichdatum editierbar, ZA loeschbar |
