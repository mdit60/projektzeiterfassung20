...
**Status:** Session 42 komplett: ZASeite, ZAPanel-Redesign, PortalFooter, ZA-Workflow live auf PROD.: Cockpit Berater-Zentrale, Config-Toggles, ZAPanel-Fix, PROD live.
...
|---------|-------|-------------|
| v4.88 | 08.05.2026 | Session 42 komplett: ZASeite, ZAPanel-Redesign, PortalFooter, ZA-Workflow live auf PROD.: PortalNav v7.4.4-17 (Cockpit async), SystemConfigPanel v7.4.4-2 (Cockpit-Toggles), ZAPanel v7.4.4-41 (foerderbetrag_gesamt Fix). PROD live, Cockpit nur system_admin. |
