...
**Status:** Session 36 komplett: Arbeitszeitgrenzen Phase 3, Dashboard-Redesign Firma-Portal, Matrix/ZA Projektteam-Quelle, Berater-Nav bereinigt.
...
| TimesheetForm.tsx | **7.4.6-14** | Phase 3 Arbeitszeitgrenzen: harte Grenzen, Zellfaerbung |
| BerichtePage.tsx | **7.4.6-9** | Dashboard + Meine Projekte integriert + MA-Redirect-Fix |
...
| ZAPanel.tsx | **7.4.4-32** | Quelle: projectAssignments; Foerderformat-Kommentar bereinigt |
