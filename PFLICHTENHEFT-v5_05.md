...
| TimesheetForm.tsx | **7.4.6-30** | A-021 NWM-Tagessperren + Cross-Projekt 9h-Grenze, A-002/A-003; A-026 U/K/S in AP-Zelle als Fehlzeit; v7.4.6-25..29 Doppelsave-Schutz (savingRef/setSaving) + UX (Pfeilnav ueber Feiertage/Sperren, Abwesenheit+Arbeit-Schutz, Fehler-Reset bei Zellwechsel, blaue AP-Restzahl in offen-Spalte); A-030 v7.4.6-30 Meine-Arbeitspakete-Popup |
...
| StundennachweisMatrix.tsx | **7.4.6-3** | Quelle: projectAssignments (Projektteam); A-029 Sammeldruck-Modus (Auswahl Spalten/Zeilen/Zellen -> StundennachweisSheet-PDF, nur Blaetter im Druck via #snw-print-root) |
