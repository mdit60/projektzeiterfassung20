-- V7 MIGRATION: Arbeitspakete und Zuordnungen v7
-- Stand: 03. Januar 2026
-- FIX: Mapping ueber user_profiles.id (nicht user_id!)
...
-- SCHRITT 3: User-Employee Mapping ueber user_profiles.id und email
...
SELECT DISTINCT
    ...
    up.email as matched_email
FROM user_profiles up
JOIN v7_employees v7e ON v7e.email = up.email
