...
**Status:** V7.4.4-4 deployed auf v7-dev + main - Berater-Portal Navigation komplett ueberarbeitet
...
- **ZA-Modul (Kachel 4) - Naechste Prioritaet:**
  ...
  2. ProjectDetailPage/-CreateForm: Foerdersatz + Overhead-Felder ergaenzen
