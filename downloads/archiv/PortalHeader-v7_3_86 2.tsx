...
// Das ermoeglicht Kompatibilitaet mit allen Seitentypen
...
interface PortalHeaderProps {
  ...
  userName: string;
  userEmail?: string;           // Optional gemacht
  companyName?: string;
  companyLogo?: string | null;
  currentPath?: string;
  hideNavigation?: boolean;     // NEU: Navigation ausblenden (z.B. fuer Detailseiten)
}
...
const NAV_BERATER: NavItem[] = [
  { key: 'dashboard', label: 'Dashboard', href: '/v7/berater/dashboard', icon: <LayoutDashboard size={18} /> },
...
function getNavItems(
  ...
  if (portal === 'berater') {
    ...
    // system_admin oder "Admin" String fuer Berater
    ...
    // Firmen-Portal
    // Pruefe sowohl userRole als auch portalRole
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Desktop Navigation */}
          {!hideNavigation && navItems.length > 0 && (
      ...
      {/* Mobile Navigation */}
      {!hideNavigation && mobileMenuOpen && navItems.length > 0 && (
