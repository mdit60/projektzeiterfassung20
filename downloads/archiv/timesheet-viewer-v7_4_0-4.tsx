...
//
// v7.4.0-4: FIX Direktnavigation zur Berater-ZE-Seite
//   - URL-Parameter korrigiert: employeeId -> employee
//     (Berater-ZE-Seite liest ?employee=, nicht ?employeeId=)
//   - returnUrl hinzugefuegt: Zurueck-Button in ZE fuehrt wieder zum Viewer
