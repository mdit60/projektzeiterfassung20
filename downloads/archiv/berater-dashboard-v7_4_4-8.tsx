...
// Datum: 17. April 2026
//
// v7.4.4-8: NEU: Offene Rueckfragen-Abschnitt mit Direktlinks zur ZE
        ...
        if (profile) {
          ...
          if (profile.consultant_company_id) {
            ...
            if (companyIds.length > 0) {
              ...
              // NEU v7.4.4-8: Offene Timesheet-Notizen mit Details laden
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        ...
        {/* NEU v7.4.4-8: Offene Rueckfragen */}
