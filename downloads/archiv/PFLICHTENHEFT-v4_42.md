...
**Status:** V7.4.4-20 deployed auf v7-dev + main - ZAPanel Redesign, ZA-Kachel in Berichte stabil
...
- **ZA-Modul - Naechste Schritte:**
  1. SQL-Migration ausstehend: v7_update_timestamp()-Funktion in Prod-DB anlegen,
     dann vollstaendiges Migration-Script ausfuehren (Script fertig in Abschnitt 7.27)
  2. Step 4: ZahlungsanforderungPage (3-Tab-Dialog: Deckblatt / Anlage 1a / Anlage 1b)
  3. Step 5: ZA-Status Dashboard-Indikator
- Stundensatz-Diskrepanz pruefen: Annika Arndt (Claude: 20.19 EUR vs. Robin: 20.35 EUR)
  nach Prod-DB-Migration
...
**Ende des Pflichtenhefts v4.42**
**Letzte Aktualisierung: 11. Maerz 2026**
