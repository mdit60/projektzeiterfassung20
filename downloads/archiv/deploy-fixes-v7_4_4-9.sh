#!/bin/bash
# ============================================================
# PZE Deploy: ProjectDetailPage v7.4.4-9 + ProjectTeamManager v7.4.4-3
...
SRC_TEAM="$DOWNLOADS_DIR/ProjectTeamManager-v7_4_4-3.tsx"
...
echo "=== PZE Deploy: ProjectDetailPage v7.4.4-9 + ProjectTeamManager v7.4.4-3 ==="
...
git add "$DST_DETAIL"
git add "$DST_TEAM"
git commit -m "v7.4.4-9: FIX teamMembers-Query + WorkPackageTable Props + EditDialog zweispaltig"
git push origin v7-dev
echo "v7-dev: push erfolgreich"

git checkout main
git merge v7-dev -m "v7.4.4-9: Merge v7-dev -> main"
