...
// ============================================================================
// Version: 7.4.4-9
// v7.4.4-9: NEU: Offene Rueckfragen-Abschnitt fuer Admin/PL
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // NEU v7.4.4-9: Offene Rueckfragen laden (nur fuer Admin/PL)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* NEU v7.4.4-9: Offene Rueckfragen (nur Admin/PL) */}
        {offeneNotizen.length > 0 && (portalRole === 'client_admin' || portalRole === 'project_leader') && (
          <div className="mt-8 bg-white rounded-xl border border-orange-200 p-6">
