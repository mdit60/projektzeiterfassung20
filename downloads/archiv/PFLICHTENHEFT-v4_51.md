...
**Status:** v7.4.5-2 / v7.4.4-19 / v7.4.1-2 deployed + V6-Cleanup DEV ausgefuehrt
...
- SICHERHEIT PRIO 1: v7_timesheets in PROD hat RLS=false (in DEV korrekt true) - sofort pruefen!
- SICHERHEIT PRIO 2: RLS-Migration fuer alle V7-Tabellen (erst DEV testen, dann PROD)
- DEV: Altlasten loeschen (fzul_employee_settings, fzul_vorhaben_settings, import_employees, imported_timesheets)
...
**Ende des Pflichtenhefts v4.51**
**Letzte Aktualisierung: 28. Maerz 2026**
