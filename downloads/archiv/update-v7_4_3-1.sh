#!/bin/bash
# ============================================================================
# PZE v7.4.3-1 - TimesheetForm FIX: offen-Spalte + planned_person_months
# ============================================================================

cd "$HOME/Documents/Dev/PZE" || { echo "FEHLER: PZE-Verzeichnis nicht gefunden!"; exit 1; }

echo "=========================================="
echo "PZE v7.4.3-1 - TimesheetForm Fix"
echo "=========================================="

DOWNLOADS="./downloads"
TARGET="./src/components/shared"
FILE="TimesheetForm-v7_4_3-1.tsx"
...
git commit -m "v7.4.3-1: TimesheetForm FIX - planned_person_months + offen print:hidden"
git push origin v7-dev

echo ""
echo "Merge auf main..."
git checkout main
git merge v7-dev -m "merge v7.4.3-1: TimesheetForm Fix offen-Spalte"
