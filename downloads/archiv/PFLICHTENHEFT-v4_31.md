...
**Version:** 4.31
**SW-Release:** V7.3.94-1
**Datum:** 17. Februar 2026
**Projekt:** Projektzeiterfassung fuer FuE-Foerdervorhaben
**Status:** V7 Entwicklung - Berater-Verwaltung, PortalNav Berater-Portal
...
| PortalHeader.tsx | 7.3.91-1 | Header mit Portal-Farben, Logo klickbar, PW-Aendern |
| PortalNav.tsx | 7.3.94 | Portal-Navigation: kumulative Rollen, Admin-Link |
...
| TimesheetForm.tsx | 7.3.93 | Zeiterfassung mit PDF-Export (window.print), T/NT |
...
- User Manuals erstellen (Firmen-Portal + Berater-Portal)

### 9.2 Mittelfristig (v7.3.95+)
