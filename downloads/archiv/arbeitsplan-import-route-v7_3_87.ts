 ...
 */
function parseAPNumber(apStr: string): { ap_number: number; ap_sub_number: number | null; ap_code: string } | null {
  if (!apStr || typeof apStr !== 'string') return null;
