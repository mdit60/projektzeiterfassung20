...
**Status:** V7.4.4-21 + V7.4.3-9 deployed auf v7-dev + main
...
### 6.6 Gestaffelte Foerderquoten ZIM-Netzwerk (offen)

ZIM-Netzwerk: Foerderquote sinkt pro Phase (80% -> 60% -> 40%).
Aktuell: Nur ein Foerdersatz pro Projekt.
Geplant: Tabelle `v7_project_foerdersatz_stufen` mit gueltig_von/gueltig_bis/foerdersatz.
Entscheidung (mit Katrin): Manuell (Option A) oder automatisch aus Projektstart (Option B).
Status: In Diskussion, Umsetzung folgt.
...
- Gestaffelte Foerderquoten ZIM-Netzwerk (nach Abstimmung mit Katrin)
