...
**Version:** 4.32
**SW-Release:** V7.3.95-4
**Datum:** 18. Februar 2026
**Projekt:** Projektzeiterfassung fuer FuE-Foerdervorhaben
**Status:** V7 Entwicklung - Ampel-Fix, Manual-Download, Passwort-Fix, User Manuals
...
| EmployeeManagement.tsx | 7.3.95 | Volle MA-Verwaltung mit CRUD, Login-Verknuepfung |
| Modal.tsx | 7.3.42 | Generische Modal-Komponente |
| PortalHeader.tsx | 7.3.95-3 | Header mit Portal-Farben, Logo klickbar, PW-Aendern, print:hidden |
...
| ProjectTeamManager.tsx | 7.3.95 | Team-Verwaltung mit editierbarer Lfd. Nr. und Rollen |
...
| /v7/firma/dashboard | 7.3.90 | Firmen-Dashboard mit Modul-Kacheln |
...
| /v7/firma/zeiterfassung | 7.3.91 | Zeiterfassung mit returnUrl-Navigation |
| /v7/firma/berichte | 7.3.90 | Berichte mit Rollencheck |
| /v7/firma/meine-projekte | 7.3.90 | Redirect auf /v7/firma/projekte |
| /v7/firma/mein-status | 7.3.95-3 | Zeiterfassungs-Uebersicht mit Ampel, Manual-Download |
...
1. User-Info (Name, Rolle) - nur Anzeige
...
Passwort-Reset (vergessen): Nur durch Systemadministrator (neues Passwort vergeben).
