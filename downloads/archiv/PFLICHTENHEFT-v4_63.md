...
**Status:** Session 19: ProjectTeamManager employment_end-Limit + Status-Fix, EmployeeManagement Ausgeschieden-Badge + Sync, WorkPackageTable 3 Dezimalstellen, TimesheetForm MA-Sortierung nach Team-Nr.
...
| TimesheetForm.tsx | 7.4.3-18 | ZE + Monatsabschluss + Schutz + MA-Sortierung nach Team-Nr. |
