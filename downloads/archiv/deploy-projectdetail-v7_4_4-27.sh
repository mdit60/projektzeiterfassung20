...
SRC="$PROJECT_DIR/downloads/ProjectDetailPage-v7_4_4-27.tsx"
DST="$PROJECT_DIR/src/components/shared/ProjectDetailPage.tsx"
echo "=== PZE Deploy: ProjectDetailPage v7.4.4-27 ==="
...
cp "$SRC" "$DST"
git add "$DST"
git commit -m "v7.4.4-27: FIX ArbeitsplanImport as any cast"
git push origin v7-dev
git checkout main
git merge v7-dev -m "v7.4.4-27: Merge v7-dev -> main"
