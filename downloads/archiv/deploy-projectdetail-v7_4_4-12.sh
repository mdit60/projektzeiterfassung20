#!/bin/bash
# ============================================================
# PZE Deploy: ProjectDetailPage v7.4.4-12
# BASIS: v7_4_4-5 (letzte funktionierende Version)
# EINZIGE Aenderung: ProjectTeamManager Props korrigiert
#   companyId -> clientCompanyId
#   onTeamChanged -> onTeamChange
#   isAdmin -> canEdit
# ALLE anderen heutigen Patches ZURUECKGENOMMEN
# ============================================================
...
SRC="$DOWNLOADS_DIR/ProjectDetailPage-v7_4_4-12.tsx"
DST="$PROJECT_DIR/src/components/shared/ProjectDetailPage.tsx"

echo "=== PZE Deploy: ProjectDetailPage v7.4.4-12 ==="
...
git add "$DST"
git commit -m "v7.4.4-12: Basis v7_4_4-5 wiederhergestellt + nur ProjectTeamManager Props fix"
git push origin v7-dev
echo "v7-dev: push erfolgreich"

git checkout main
git merge v7-dev -m "v7.4.4-12: Merge v7-dev -> main"
