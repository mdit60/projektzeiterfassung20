#!/bin/bash
# ============================================================================
# PZE v7.4.2-5 - WorkPackageTable: Eigene Spalten + Accordion
# ============================================================================

cd "$HOME/Documents/Dev/PZE" || { echo "FEHLER: PZE-Verzeichnis nicht gefunden!"; exit 1; }

echo "=========================================="
echo "PZE v7.4.2-5 - WorkPackageTable Update"
echo "Verzeichnis: $(pwd)"
echo "=========================================="

DOWNLOADS="./downloads"
TARGET="./src/components/shared"
FILE="WorkPackageTable-v7_4_2-5.tsx"
...
git commit -m "v7.4.2-5: WorkPackageTable - Eigene Spalten Soll/Erfasst/Frei + Kontrollsummen Accordion"
git push origin v7-dev

echo ""
echo "Merge auf main..."
git checkout main
git merge v7-dev -m "merge v7.4.2-5: WorkPackageTable eigene Spalten + Accordion"
