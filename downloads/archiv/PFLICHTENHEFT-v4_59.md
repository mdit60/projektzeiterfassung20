...
**Status:** Session 16: ZA-Rollback, NWM EA USt-Anteil, Stundennachweis Wording
...
Entwurf --> Eingereicht --> Bewilligt
                |                |
                v                v
            Entwurf          Eingereicht (Rollback, NEU v7.4.4-27)
```

Rollback Bewilligt -> Eingereicht: Implementiert in ZAPanel v7.4.4-27.
...
- ZA-Rollback-Button Bewilligt -> Eingereicht: ERLEDIGT v7.4.4-27
...
|---------|-------|-------------|
| v4.59 | 15.04.2026 | Session 16: ZA-Rollback Bewilligt->Eingereicht (ZAPanel-27), NWM EA Perioden-Dropdown entfernt + USt-Anteil statt Brutto (NWMEigenanteilPanel-12), Stundennachweis Wording ZIM_NETZWERK Management-Arbeiten (TimesheetForm-14) |
| v4.58 | 15.04.2026 | Session 15: Navigation Berater-Portal, Zurueck-Buttons ergaenzt, Navigations-Hierarchie dokumentiert |
