...
**Status:** V7.4.3-12 deployed - Stundennachweis-Matrix in Berichte (Firma + Berater)
...
- ~~Berater-Berichte-Seite: gleiche Fixes wie Firmen-Portal uebertragen~~ ERLEDIGT v7.4.3-11
...
- Reports-Kacheln weiter ausbauen:
  - Personalkosten: Excel-Export mit Jahresscheiben (Anlage 5)
  - Projekt-Fortschritt: Grafische Auswertung (Zeitstrahl + Kostenkurve)
  - Zahlungsanforderung: ZA-Modul Integration (Zeitraum-Auswahl, PDF-Formular)
