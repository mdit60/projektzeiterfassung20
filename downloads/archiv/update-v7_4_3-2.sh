#!/bin/bash
# ============================================================================
# PZE v7.4.3-2 - TimesheetForm: offen aktualisiert nach Speichern
# ============================================================================

cd "$HOME/Documents/Dev/PZE" || { echo "FEHLER: PZE-Verzeichnis nicht gefunden!"; exit 1; }

echo "=========================================="
echo "PZE v7.4.3-2 - TimesheetForm Fix"
echo "=========================================="

DOWNLOADS="./downloads"
TARGET="./src/components/shared"
FILE="TimesheetForm-v7_4_3-2.tsx"
...
git commit -m "v7.4.3-2: TimesheetForm - offen-Spalte aktualisiert sofort nach Speichern"
git push origin v7-dev

echo ""
echo "Merge auf main..."
git checkout main
git merge v7-dev -m "merge v7.4.3-2: offen-Spalte live-Update nach Speichern"
