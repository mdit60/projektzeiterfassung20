#!/bin/bash
# ============================================================
# PZE Deploy: ProjectDetailPage v7.4.4-8
# FIX: WorkPackageTable alle Props korrigiert
#      employees={allEmployees}, canEdit={adminUser},
#      onEditAP, onDeleteAP (statt onEdit, onDelete, isAdmin)
# ============================================================
...
SRC="$DOWNLOADS_DIR/ProjectDetailPage-v7_4_4-8.tsx"
DST="$PROJECT_DIR/src/components/shared/ProjectDetailPage.tsx"

echo "=== PZE Deploy: ProjectDetailPage v7.4.4-8 ==="
...
git add "$DST"
git commit -m "v7.4.4-8: FIX WorkPackageTable alle Props korrigiert (employees, canEdit, onEditAP, onDeleteAP)"
