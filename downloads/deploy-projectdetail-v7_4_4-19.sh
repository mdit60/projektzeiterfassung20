...
SRC="$PROJECT_DIR/downloads/ProjectDetailPage-v7_4_4-19.tsx"
DST="$PROJECT_DIR/src/components/shared/ProjectDetailPage.tsx"
echo "=== PZE Deploy: ProjectDetailPage v7.4.4-19 ==="
...
cp "$SRC" "$DST"
git add "$DST"
git commit -m "v7.4.4-19: FIX companyId aus useEffect Dependencies entfernt"
git push origin v7-dev
git checkout main
git merge v7-dev -m "v7.4.4-19: Merge v7-dev -> main"
