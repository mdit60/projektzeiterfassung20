...
const PORTAL_COLORS = {
  berater: {
    ...
    kachelBg: 'bg-white',
    kachelBgHover: 'hover:bg-blue-50',
  ...
  firma: {
    ...
    kachelBg: 'bg-white',
    kachelBgHover: 'hover:bg-green-50',
  ...
  return (
    <>
      ...
      <button
        ...
        onMouseEnter={e => {
          if (!showPanel) {
            (e.currentTarget as HTMLButtonElement).style.backgroundColor = portal === 'berater' ? '#eff6ff' : '#f0fdf4';
          }
        }}
        onMouseLeave={e => {
          if (!showPanel) {
      ...
      {/* Panel - col-span-4 um volle Grid-Breite zu nutzen */}
      {showPanel && (
        <div className={`col-span-1 md:col-span-2 lg:col-span-4 mt-2 border ${colors.border} rounded-lg overflow-hidden`}>
