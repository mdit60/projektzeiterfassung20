...
// VERSION: v7.3.21 (SW-Release V7.3)
// DATUM: 20. Januar 2026
// BESCHREIBUNG: Mitarbeiter-Verwaltung im Firmen-Portal
// ÄNDERUNG v7.3.20: hourly_rate entfernt (gehört zu v7_project_assignments, nicht v7_employees)
// ÄNDERUNG v7.3.21: Überflüssigen Stundensatz-Hinweis entfernt
      ...
      <footer className="bg-white border-t border-gray-200 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <p className="text-center text-sm text-gray-500">
            Projektzeiterfassung v7.3.21 · Firmen-Portal · © {new Date().getFullYear()}
          </p>
        </div>
      </footer>
