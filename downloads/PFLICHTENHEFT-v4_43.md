...
**Status:** V7.4.4-16 deployed auf v7-dev + main - ZA-Kachel umbenannt, ZIM-Hinweiskasten eingefuegt
...
- **Strategische Entscheidung ZA-Modul (12.03.2026):**
  ...
  ZA-Modul wird vereinfacht: NUR Datenaufbereitung fuer manuellen Uebertrag.
  ZA-Wizard und PDF-Ausgabe entfallen.
- **ZA-Modul - Noch offen:**
  1. ZA-Archiv: Liste gespeicherter ZAs pro Projekt mit Status
     (Entwurf / Eingereicht / Bewilligt)
  2. Faelligkeits-Ampel: Wann ist naechste ZA faellig? (Dashboard)
...
**Ende des Pflichtenhefts v4.43**
**Letzte Aktualisierung: 12. Maerz 2026**
