...
-- Stand: 03. Januar 2026 (v4 - mit ENUM Cast)
-- ============================================
...
SELECT 
    ...
    up.last_name,
    up.name,
    'system_admin'::v7_user_role,  -- ENUM Cast!
    '4f20d4bc-588d-4291-bc0b-995943533829',
    NULL,
    true
...
SELECT 
    ...
    up.last_name,
    up.name,
    'consultant'::v7_user_role,  -- ENUM Cast!
    '4f20d4bc-588d-4291-bc0b-995943533829',
    NULL,
    true
FROM user_profiles up
...
SELECT 
    ...
    CASE 
        WHEN up.role = 'admin' THEN 'client_admin'::v7_user_role
        ELSE 'client_user'::v7_user_role
    END AS role,
