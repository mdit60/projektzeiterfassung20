...
**Status:** Session 18: Login-Bug upsert-Fix, Dialog-Vereinheitlichung Team, Status-Fix, Student als Qualifikation
...
| EmployeeManagement.tsx | 7.3.95-5 | MA-Verwaltung, Login, PW-Reset, Student als Qualifikation |
...
| ProjectTeamManager.tsx | 7.4.4-9 | Team-Verwaltung, Dialog-Vereinheitlichung, Status-Fix |
...
| 5.26 | ProjectTeamManager: Status "Ausgeschieden" bei zukuenftigem Enddatum | Behoben | v7.4.4-9 |
...
|---------|-------|-------------|
| v4.62 | 17.04.2026 | Session 18: create-employee-login upsert-Fix (duplicate key Supabase-Trigger), ProjectTeamManager-9 Dialog-Vereinheitlichung + Status-Fix (assignment_end Datum), EmployeeManagement-5 Student als Qualifikation |
