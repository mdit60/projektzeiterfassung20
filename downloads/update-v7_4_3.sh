#!/bin/bash
# ============================================================================
# PZE v7.4.3 - TimesheetForm: offen-Spalte + AP-Vorbelegung
# ============================================================================

cd "$HOME/Documents/Dev/PZE" || { echo "FEHLER: PZE-Verzeichnis nicht gefunden!"; exit 1; }

echo "=========================================="
echo "PZE v7.4.3 - TimesheetForm Update"
echo "Verzeichnis: $(pwd)"
echo "=========================================="

DOWNLOADS="./downloads"
TARGET="./src/components/shared"
FILE="TimesheetForm-v7_4_3.tsx"
...
git commit -m "v7.4.3: TimesheetForm - offen-Spalte pro AP + AP-Vorbelegung aus Arbeitsplan"
git push origin v7-dev

echo ""
echo "Merge auf main..."
git checkout main
git merge v7-dev -m "merge v7.4.3: TimesheetForm offen-Spalte + AP-Vorbelegung"
