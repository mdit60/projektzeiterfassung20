...
// Version: 7.4.4-48
//
// v7.4.4-48: FIX: fromNWMList als useState statt berechneter Variable
//   (searchParams konnte bei Re-Render verloren gehen -> Zurueck-Button
//    navigierte zur Firma statt zur NWM-Uebersicht)
//   FIX: bg-black/50 -> bg-black bg-opacity-50 (SWC-Compiler-Bug:
//    Slash in Tailwind-Klasse wurde als Regex-Literal interpretiert)
                      ...
                      <p className="mt-1 text-gray-900">
                        ...
                        {project.bewilligte_summe != null && (
                          <span className="ml-3 font-medium text-green-700">
                            {new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR', maximumFractionDigits: 0 }).format(project.bewilligte_summe)}
                          </span>
                        )}
                      </p>
                    </div>
