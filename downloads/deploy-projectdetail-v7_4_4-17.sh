...
SRC="$PROJECT_DIR/downloads/ProjectDetailPage-v7_4_4-17.tsx"
DST="$PROJECT_DIR/src/components/shared/ProjectDetailPage.tsx"
echo "=== PZE Deploy: ProjectDetailPage v7.4.4-17 (DEBUG) ==="
...
cp "$SRC" "$DST"
git add "$DST"
git commit -m "v7.4.4-17: DEBUG loadData Aufrufe tracen"
git push origin v7-dev
git checkout main
git merge v7-dev -m "v7.4.4-17: Merge v7-dev -> main"
