...
**Status:** RLS vollstaendig aktiv PROD + atomarer Login-Prozess deployed
...
|---------|-------|-------------|
| v4.54 | 01.04.2026 | Session 11: RLS vollstaendig PROD (user_profiles + timesheets), atomare Login-Route deployed, Login-Bug Stoma behoben |
