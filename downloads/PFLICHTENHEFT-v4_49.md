...
**Status:** v7.4.5-1 (ProjektFortschrittPanel) / v7.4.4-18 (berichte-page) deployed
...
| ProjektFortschrittPanel.tsx | 7.4.5-1 | Grafische Auswertung: PM/Kosten/Laufzeit/Monatsverlauf |
...
| /v7/firma/berichte | berichte-page-18 | Berichte + ZA + Matrix + Fortschritt (Bug: Kachel zeigt Demnaechst) |
...
| /v7/berater/foerderung | berater-firma-list | Kundenfirmen-Liste |
| /v7/berater/foerderung/firma/[id] | berater-firma-detail | Firma-Detail |
| /v7/berater/foerderung/firma/[id]/projekt/[pid] | ProjectDetailPage-38 | Projekt + NWM |
...
- BUG PRIO 1: Projektfortschritt-Kachel zeigt Demnaechst trotz korrektem Code
  (DevTools pruefen, evtl. Next.js Cache leeren, Trigger-Zeile entfernen)
- berater-berichte-page analog berichte-page-18 aktualisieren
...
- Personalkosten Excel-Export (Berichte-Kachel)
...
|---------|-------|-------------|
| v4.49 | 26.03.2026 | Session 8: NWM-Modul komplett, NWM-Uebersicht, Dashboard-Redesign, Monatsabschluss-Schutz, PW-Reset, mein-status Completion-Fix, ProjektFortschrittPanel (Bug offen) |
