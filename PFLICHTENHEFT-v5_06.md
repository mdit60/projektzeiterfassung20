...
| StundennachweisMatrix.tsx | **7.4.6-4** | Quelle: projectAssignments (Projektteam); A-029 Sammeldruck-Modus (Auswahl Spalten/Zeilen/Zellen -> StundennachweisSheet-PDF, nur Blaetter im Druck via #snw-print-root); A-032 MA-Zeilen auf aktives Projekt gefiltert (Mehr-Projekt-Firmen) |
