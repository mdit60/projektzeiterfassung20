...
**Status:** Session 43: Neue App-Struktur (parallel), Ansicht-Wechsler, Inline-MA-Modal, Navigation-Redesign
...
| PortalNav.tsx | **7.4.4-19** | App-Modus: Cockpit->App, Kundenfirmen ausgeblendet |
| AppNav.tsx | **1.0.0** | Neue Navigation fuer App-Struktur |
...
| src/app/v7/berater/multiprojekt/page.tsx | **7.4.8-12** | KPT: Dashboard-Link App-Modus ausgeblendet |
