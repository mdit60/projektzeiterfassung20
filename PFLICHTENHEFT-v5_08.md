...
| TimesheetForm.tsx | **7.4.6-43** | A-021 NWM-Tagessperren + projektuebergreifende 9h-Tagesgrenze (gilt generell), A-002/A-003; A-026 U/K/S in AP-Zelle als Fehlzeit; Doppelsave-Schutz; A-030 Meine-Arbeitspakete-Popup; A-033 MA-Auswahl aufs Projektteam; **v7.4.6-43 Soll + Foerder-Monatsgrenze projektbasiert via hoursPerPM(pmBasis) (160,33 bei 37h), NEU physischer projektuebergreifender Monatsdeckel = hoursPerPM(echte weekly_hours)=162,50h (harte Sperre)** |
| BerichtePage.tsx | **7.4.6-19** | Dashboard + .limit(10000); A-035 oberer Projekt-Dropdown setzt selectedReportProjectId UND matrixProjectId synchron; v7.4.6-19 pm_basis_weekly_hours in Select + Interface -> an ProjektFortschrittPanel durchgereicht |
...
| src/app/v7/firma/zeiterfassung/page.tsx | **7.4.6-3** | ZE-Wrapper Firmen-Portal; v7.4.6-3 pm_basis_weekly_hours im Projekt-Select |
| src/app/v7/berater/foerderung/firma/[id]/zeiterfassung/page.tsx | **7.4.6-3** | ZE-Wrapper Berater-Portal; v7.4.6-3 pm_basis_weekly_hours im Projekt-Select |
