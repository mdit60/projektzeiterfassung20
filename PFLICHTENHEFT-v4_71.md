...
**Status:** Session 26 abgeschlossen: AP-Dropdown und Matrix-Vorbelegung in TimesheetForm nach Laufzeit gefiltert, Ueberschriften-APs aus Auswahl entfernt, Sortierung der vorbelegten AP-Zeilen nach ap_number/ap_sub_number. Phase 2 Arbeitszeitgrenzen abgeschlossen; Phase 3 (Live-Validierung mit Ampel-Trio) ist naechster Meilenstein.
...
| Route | Komponente | Beschreibung |
|-------|-----------|--------------|
| /v7/berater/dashboard | berater-dashboard-v7_4_4-10 | 4 Kacheln + Offene Rueckfragen |
