...
**Status:** Session 48: A-011 erledigt (ProjektFortschrittPanel auf gemeinsame Rechenquelle projektfortschritt-utils). Drei Werkbank-Funde ausgeliefert: Neues-Unternehmen-Button, modus-bewusster Zurueck-Button, voller Name in Cockpit.
...
| TimesheetForm.tsx | **7.4.6-20** | Phase 3 Arbeitszeitgrenzen + Feiertags-Auto-Fill + AP-Druck-Fix |
...
| src/app/v7/berater/app/cockpit/page.tsx | **1.0.5** | Berater-App-Cockpit (4 Kacheln + Firma-Dropdown); "Neues Unternehmen anlegen"-Button (A-014); voller Name in Begruessung+Header (A-016) |
...
| A-002 | Stundennachweis-Wording projekttyp-spezifisch: bei ZIM_NETZWERK "Management-Arbeiten" statt "foerderbare Projektarbeiten" | Martin | Session <=42 | Offen | - | TimesheetForm (Stand S46): feste Beschriftung, kein isNetzwerk-Zweig. Re-verifiziert Session 47. Siehe TS-3. |
| A-003 | AP-Quick-View Popup in TimesheetForm: Icon/Button neben Projekt-Dropdown oeffnet Popup mit AP-Liste (Laufzeiten + geplante PM), schliesst ohne State-Verlust | Martin | Session <=42 | Offen | - | TimesheetForm (Stand S46): nur Notiz-Modal vorhanden. Re-verifiziert Session 47. |
...
| A-006 | FZul-Modul ausbauen (PortalHeader + PortalNav, Multiprojekt-Zuordnung) | Martin | Session <=42 | Offen | - | Konzept KONZEPT-MULTIPROJEKT-FZUL. Cockpit zeigt "Kommt bald". |
...
| A-013 | Alte verwaiste Seite v7/firmen/[id]/page.tsx (v7.0.3) aufraeumen | Claude (Audit) | Session 47 | Offen | - | Toter Code, kein PortalHeader, Nicht-ASCII. Aktive Firmenansicht ist FirmaCockpit (/v7/berater/app/firma/[id]). Siehe TS-8. |
...
| A-017 | Werkbank-Bereinigung: lokale Arbeitskopie driftet seit Session 44 von deployed. (a) verirrte src/app/v7/berater/foerderung/foerderung-page.tsx (Upload-Kopie, untracked) loeschen; (b) alte uncommittete fzul/page.tsx-Aenderung entscheiden/verwerfen (laut Martin nur Platzhalter); (c) pg-Dependency + sync-prod-to-dev-Skripte handhaben (lokales Werkzeug, nicht App; package.json/pnpm-lock uncommitted); (d) docs/Supabase-docx | Claude (Audit) | Session 48 | Offen | - | Befund aus git status Session 48. Nicht ausgeliefert, bewusst auf der Werkbank belassen. |
| A-018 | refreshed-Lose-Ende: App-Cockpit horcht auf ?refreshed=true, Foerderseite sendet den Parameter beim Redirect nicht -> Mechanismus aktuell inert. Entweder Parameter mitsenden oder Listener entfernen | Claude (Audit) | Session 48 | Offen | - | Funktional unkritisch (Cockpit laedt bei Remount ohnehin neu). cockpit v1.0.5, foerderung v7.4.1-10. |
| A-019 | Namens-Vereinheitlichung: ProjektFortschrittPanel (deutsch, K) vs. Project*-Dateien (englisch, C). Umbenennung beruehrt alle Importe | Claude (Audit) | Session 48 | Offen | - | Niedrige Prio. |
...
| TS-3 | Stundennachweis-Wording | "foerderbare Projektarbeiten" steht immer, bei ZIM_NETZWERK muss "Management-Arbeiten" stehen. | Mittel | Offen -> A-002 (Session 47 re-verifiziert) |
